...
import (
	...
	v1alpha1 "github.com/sonasingh46/apis/pkg/client/generated/listers/ndm/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NdmV1alpha1().BlockDeviceClaims(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NdmV1alpha1().BlockDeviceClaims(namespace).Watch(options)
			},
		},
