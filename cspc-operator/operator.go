...
import (
	"flag"
	"github.com/sonasingh46/cstor-operator/pkg/signals"
	"os"
	"strconv"
	"time"
	"github.com/sonasingh46/cstor-operator/cspc-operator/app"
	"github.com/pkg/errors"
	"k8s.io/klog"
	clientset "github.com/sonasingh46/apis/pkg/client/clientset/versioned"
	informers "github.com/sonasingh46/apis/pkg/client/informers/externalversions"
...
func Start() error {
	...
	controller, err := app.NewControllerBuilder().
